...
def delete_face():
    ...
    # 文件路径列表
    file_paths = [
        f'app/static/data/data_faces_from_camera/{sid}/1.jpg',
        f'app/static/data/data_faces_from_camera/{sid}/2.jpg',
        f'app/static/data/data_faces_from_camera/{sid}/3.jpg',
        f'app/static/data/data_faces_from_camera/{sid}/4.jpg',
        f'app/static/data/data_faces_from_camera/{sid}/5.jpg'
    ]
